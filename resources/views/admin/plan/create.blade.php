            ...
            <div class="col-xxl-12">
                <div class="card">
                    <div class="card-header">
                        <h5 class="card-title mb-0">{{ __('Crear Plan') }}</h5>
                    </div>
                    <div class="card-body">
                        @if($errors->any())
                        ...
                        @endif
                        <form action="{{ url('plan/store/') }}" method="post">
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" name="costos" value="{{ old('costos') }}" required>
                                <small class="form-text text-muted">{{ __('Campo Requerido.') }}</small>
                            </div>
                            <div class="form-group">
