            ...
            <div class="col-xxl-12">
                <div class="card">
                    <div class="card-header">
                        <h5 class="card-title mb-0">{{ __('Crear Visitante') }}</h5>
                    </div>
                    <div class="card-body">
                        @if($errors->any())
                        ...
                        @endif
                        <form action="{{ url('visitante/store/') }}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="form-group">
                                <label class="form-label" for="ip">Ip del visitante</label>
                                <input type="text" class="form-control" name="ip" value="{{ old('ip') }}" required>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="sessionid" value="{{ old('sessionid') }}">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="useragent" value="{{ old('useragent') }}">
                            </div>
