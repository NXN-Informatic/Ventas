...
<div class="bannerBlog headermax shad imgb row" style="position: relative;background: linear-gradient(85deg, #8f33ac 0%, #ff1a00 100%); padding:0px " >
    <div class="col-12 textodestacados">
        <span class="bold15 spandestacados">{{'Tiendas destacadas ('.$cantidad.')'}}</span>
    </div>
    <div class="col-12">
        <div class="clients" style="position:relative;padding-left:0px">
            <div class="clients__wrap dflex" id="wrap">
                <div class="client__item btnsecciondiv"><a class="btn btnseccionactivo shad" style="padding:10px" href="{{ url('/tiendas/destacadas') }}"><span class="bold11 subcategoria" style="color: #fff">Tiendas</span></a></div>
...
<script>
    let pageTiendas=2;
    function masTiendas(){
        fetch(`/tiendas/destacadas/mas?page=${pageTiendas}`,{
                method:'get'
        })
